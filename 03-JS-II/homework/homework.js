...
function fizzBuzz(numero) {
  ...
  const esDivisible = (dividendo, divisor) => dividendo % divisor === 0
...
function operadoresLogicos(num1, num2, num3) {
  ...
  } else if (num1 > Math.max(0, num2, num3)) {
...
function esPrimo(numero) {
  ...
  // Asumo que el valor es un entero
  if (numero <= 2) {
    return false
  }
...
function esVerdadero(valor){
  ...
  // La primer forma me parece más legible
}
...
function tablaDelSeis(){
  ...
  for (let i = 0; i <= 10; i++)  resultados.push(6 * i)
